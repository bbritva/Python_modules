...
def how_many_medals_by_country(data, country):
    ...
    data = data[(data["Team"] == country) & (data["Medal"])][['Team', 'Year', 'Sport', 'Event', 'Medal']]
